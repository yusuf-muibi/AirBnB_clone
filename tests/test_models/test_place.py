...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_created_at_is_public_datetime(self):
        self.assertEqual(datetime, type(Place().create_at))

    def test_updated_at_is_public_datetime(self):
        self.assertEqual(datetime, type(Place().changes_at))
    ...
    def test_two_places_different_created_at(self):
        ...
        sleep(0.05)
        pl2 = Place()
        self.assertLess(pl1.create_at, pl2.create_at)

    def test_two_places_different_updated_at(self):
        pl1 = Place()
        sleep(0.05)
        pl2 = Place()
        self.assertLess(pl1.changes_at, pl2.changes_at)
    ...
    def test_str_representation(self):
        ...
        pl = Place()
        pl.id = "123456"
        pl.create_at = pl.changes_at = dt
        plstr = pl.__str__()
        self.assertIn("[Place] (123456)", plstr)
        self.assertIn("'id': '123456'", plstr)
        self.assertIn("'create_at': " + dt_repr, plstr)
        self.assertIn("'changes_at': " + dt_repr, plstr)
    ...
    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        pl = Place(id="345", create_at=dt_iso, changes_at=dt_iso)
        self.assertEqual(pl.id, "345")
        self.assertEqual(pl.create_at, dt)
        self.assertEqual(pl.changes_at, dt)

    def test_instantiation_with_None_kwargs(self):
        with self.assertRaises(TypeError):
            Place(id=None, create_at=None, changes_at=None)
...
class TestPlace_save(unittest.TestCase):
    ...
    def test_one_save(self):
        pl = Place()
        sleep(0.05)
        first_updated_at = pl.changes_at
        pl.save()
        self.assertLess(first_updated_at, pl.changes_at)
    ...
    def test_two_saves(self):
        ...
        first_updated_at = pl.changes_at
        pl.save()
        second_updated_at = pl.changes_at
        self.assertLess(first_updated_at, second_updated_at)
        sleep(0.05)
        pl.save()
        self.assertLess(second_updated_at, pl.changes_at)
...
class TestPlace_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_correct_keys(self):
        ...
        self.assertIn("create_at", pl.to_dict())
        self.assertIn("changes_at", pl.to_dict())
    ...
    def test_to_dict_datetime_attributes_are_strs(self):
        ...
        self.assertEqual(str, type(pl_dict["create_at"]))
        self.assertEqual(str, type(pl_dict["changes_at"]))
